...
//         const isFresh = data.results[0].label === 'fresh';
//         playSound(isFresh);
//       }
...
//                     Sử dụng AI để phát hiện xoài tươi hay thối chỉ trong vài giây
//                   </Typography>
//                   <Button
//                     variant="contained"
//                     size="large"
...
//                       '&:hover': {
//                         background: 'linear-gradient(45deg, #FF7F00 30%, #FF8C00 90%)',
//                       },
//                     }}
//                   >
//                     Bắt Đầu Kiểm Tra
...
//                       color: 'white',
//                     }}>
//                       <CircularProgress size={60} sx={{ color: '#FFA500', mb: 2 }} />
//                       <Typography variant="h6">Đang phân tích...</Typography>
//                       <Typography variant="body2">Vui lòng đợi một chút</Typography>
//                     </Box>
//                   )}
//                 </Box>
//               </Paper>
...
//                       backgroundColor: result.label === 'fresh'
//                         ? 'rgba(50, 205, 50, 0.1)'
//                         : 'rgba(255, 68, 68, 0.1)',
//                       border: result.label === 'fresh'
//                         ? '2px solid #32CD32'
//                         : '2px solid #FF4444',
//                     }}>
...
//                         fontWeight: 600,
//                         color: result.label === 'fresh' ? 'secondary.dark' : 'error.dark',
//                         mb: 1,
//                       }}>
//                         {result.message}
//                       </Typography>
...
//                       <Chip
//                         label={`${result.confidence}% chắc chắn`}
